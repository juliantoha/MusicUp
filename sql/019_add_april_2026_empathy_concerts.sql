...
-- Concert 1: Oakmont of Silver Creek - April 11, 2026 at 10:30 AM PT
...
SELECT
  s.id,
  v.id,
  '2026-04-11 10:30:00-07'::timestamptz,
  '2026-04-11 11:00:00-07'::timestamptz,
  'scheduled'
...
-- Concert 2: Oakmont of Silver Creek - April 11, 2026 at 11:00 AM PT
INSERT INTO public.concerts (
  series_id,
  venue_id,
  starts_at,
...
SELECT
  ...
  v.id,
  '2026-04-11 11:00:00-07'::timestamptz,
  '2026-04-11 11:30:00-07'::timestamptz,
  'scheduled'
FROM public.series s
CROSS JOIN public.venues v
WHERE s.slug = 'empathy'
